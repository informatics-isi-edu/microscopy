...
import base64
import urlparse
from httplib import HTTPConnection, HTTPSConnection, HTTPException, OK, CREATED, ACCEPTED, NO_CONTENT, CONFLICT, FORBIDDEN, INTERNAL_SERVER_ERROR, SERVICE_UNAVAILABLE
import sys
import traceback
import time
import shutil
...
class ErmrestClient (object):
    ...
    def send_request(self, method, url, body='', headers={}):
        ...
        if resp.status not in [FORBIDDEN, INTERNAL_SERVER_ERROR, SERVICE_UNAVAILABLE]:
            self.close()
            self.connect()
